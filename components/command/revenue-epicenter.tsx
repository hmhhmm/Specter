...
export function RevenueEpicenter() {
  ...
  return (
    <div className="flex flex-col gap-4 h-full max-h-full">
      {/* Revenue Ticker */}
      <div className="rounded-lg bg-zinc-100/60 dark:bg-zinc-900/60 border border-zinc-200 dark:border-zinc-800 p-8 flex flex-col items-center justify-center relative overflow-hidden transition-colors duration-300" style={{height: '55%'}}>
        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          ...
          >
            ...
            <span className="text-[10px] font-mono text-amber-700 dark:text-amber-500 uppercase tracking-[0.2em] font-bold">Projected Annual Revenue Leak</span>
          </motion.div>
          
          <div className="flex items-start">
            <span className="text-4xl md:text-5xl font-bricolage font-bold text-amber-600/40 dark:text-amber-500/40 mt-4 md:mt-6">$</span>
            <motion.h2 
              className="text-7xl md:text-9xl font-bricolage font-bold tracking-tighter text-amber-600 dark:text-amber-500 drop-shadow-[0_0_30px_rgba(245,158,11,0.3)]"
            >
              <CountUp value={revenue} />
            </motion.h2>
          </div>
          
          <p className="max-w-xs text-zinc-600 dark:text-zinc-500 text-[10px] mt-4 uppercase tracking-wide leading-relaxed transition-colors duration-300">
      ...
      <div className="rounded-lg bg-zinc-100/60 dark:bg-zinc-900/60 border border-zinc-200 dark:border-zinc-800 p-6 flex flex-col md:flex-row gap-6 items-center transition-colors duration-300" style={{height: '42%'}}>
        <div className="relative w-48 h-48 shrink-0">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center pointer-events-none">
            <span className="text-[9px] font-mono text-zinc-600 dark:text-zinc-500 uppercase tracking-widest leading-none mb-1">Leak Distribution</span>
            <AnimatePresence mode="wait">
              <motion.span 
                ...
                exit={{ opacity: 0, y: -5 }}
                className="text-lg font-bold font-bricolage text-zinc-900 dark:text-white transition-colors duration-300"
              >
        ...
        <div className="flex-1 space-y-5 w-full">
           ...
           <div className="pt-4 border-t border-zinc-200 dark:border-white/5">
             <div className="flex items-center gap-2">
               <AlertCircle className="w-3 h-3 text-zinc-400 dark:text-zinc-600" />
               <span className="text-[8px] font-mono text-zinc-500 dark:text-zinc-600 uppercase tracking-widest">Hover segments to simulate recovery</span>
             </div>
           </div>
        </div>
      </div>
