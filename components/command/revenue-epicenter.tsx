      ...
      <div className="space-y-5">
        <div>
          <div className="flex justify-between items-center mb-2">
            <span className="text-sm text-zinc-700 dark:text-zinc-300">Checkout Abandonment</span>
            <span className="text-sm font-bold text-red-500 dark:text-red-400">42%</span>
          </div>
          <div className="relative h-2 bg-zinc-200 dark:bg-white/5 rounded-full overflow-hidden">
            <div className="absolute inset-y-0 left-0 bg-gradient-to-r from-red-500 to-red-600 rounded-full" style={{width: '42%'}} />
          </div>
          <p className="text-xs text-zinc-500 dark:text-zinc-500 mt-1">Chat widget blocking CTA button</p>
        </div>

        <div>
          <div className="flex justify-between items-center mb-2">
            <span className="text-sm text-zinc-700 dark:text-zinc-300">Form Drop-off Rate</span>
            <span className="text-sm font-bold text-orange-500 dark:text-orange-400">28%</span>
          </div>
          <div className="relative h-2 bg-zinc-200 dark:bg-white/5 rounded-full overflow-hidden">
            <div className="absolute inset-y-0 left-0 bg-gradient-to-r from-orange-500 to-orange-600 rounded-full" style={{width: '28%'}} />
          </div>
          <p className="text-xs text-zinc-500 dark:text-zinc-500 mt-1">Keyboard focus trap in modal</p>
        </div>

        <div>
          <div className="flex justify-between items-center mb-2">
            <span className="text-sm text-zinc-700 dark:text-zinc-300">Mobile Bounce Rate</span>
            <span className="text-sm font-bold text-yellow-500 dark:text-yellow-400">15%</span>
          </div>
          <div className="relative h-2 bg-zinc-200 dark:bg-white/5 rounded-full overflow-hidden">
            <div className="absolute inset-y-0 left-0 bg-gradient-to-r from-yellow-500 to-yellow-600 rounded-full" style={{width: '15%'}} />
          </div>
          <p className="text-xs text-zinc-500 dark:text-zinc-500 mt-1">Unresponsive UI on slow networks</p>
        </div>
      </div>
    </div>
  );
