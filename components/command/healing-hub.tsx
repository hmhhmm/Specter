...
export function HealingHub() {
  ...
  return (
    <div className="flex flex-col h-full min-h-0">
      ...
      <div className="rounded-lg bg-zinc-100/60 dark:bg-zinc-900/60 border border-zinc-200 dark:border-zinc-800 p-4 flex flex-col flex-1 min-h-0 relative overflow-hidden transition-colors duration-300">
        
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded bg-zinc-200 dark:bg-zinc-800/50 border border-zinc-300 dark:border-zinc-700 flex items-center justify-center transition-colors duration-300">
              <Cpu className="w-4 h-4 text-blue-600 dark:text-blue-400" />
            </div>
            <div>
              <h3 className="text-sm font-semibold text-zinc-900 dark:text-white transition-colors duration-300">Auto-Remediation</h3>
              <p className="text-[10px] text-zinc-600 dark:text-zinc-500 uppercase tracking-wide transition-colors duration-300">System Active</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative w-12 h-12">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className={`text-[10px] font-bold ${confidence >= 80 ? 'text-emerald-600 dark:text-emerald-400' : 'text-amber-600 dark:text-amber-400'}`}>
                  {confidence}%
                </span>
              </div>
            </div>
        ...
        <div className="mb-6 rounded-2xl bg-emerald-500/5 border border-emerald-500/10 p-4 relative group/suggestion overflow-hidden">
          ...
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-[8px] font-mono text-zinc-500 dark:text-zinc-600 bg-zinc-200 dark:bg-zinc-900/50 px-2 py-0.5 rounded-full border border-zinc-300 dark:border-white/5 transition-colors duration-300">SHA-256: 8f2a...</span>
          </div>
          <p className="text-xs text-zinc-800 dark:text-zinc-200 leading-relaxed font-medium transition-colors duration-300">
            {suggestion?.description || "Analyzing codebase for potential fixes..."}
          </p>
          <p className="text-[10px] text-zinc-600 dark:text-zinc-500 mt-2 italic transition-colors duration-300">
        ...
        <div className="flex-1 flex flex-col min-h-0 overflow-hidden">
          <div className="flex items-center justify-between mb-4 px-1 shrink-0">
            <div className="flex items-center gap-2">
              <Terminal className="w-3 h-3 text-zinc-600 dark:text-zinc-500" />
              <span className="text-[9px] font-mono text-zinc-700 dark:text-zinc-500 uppercase tracking-widest font-bold transition-colors duration-300">Proposed Patch</span>
            </div>
            <span className="text-[8px] font-mono text-zinc-500 dark:text-zinc-700 uppercase tracking-widest">{ displayFile}</span>
          </div>
          
          <div className="flex-1 bg-zinc-50 dark:bg-[#080808] rounded-2xl border border-zinc-200 dark:border-white/5 font-mono text-[10px] leading-relaxed relative overflow-hidden flex flex-col group/code min-h-0 transition-colors duration-300">
            <div className="absolute inset-0 opacity-[0.03] pointer-events-none bg-[url('https://grainy-gradients.vercel.app/noise.svg')]" />
            
            <div className="flex-1 min-h-0 overflow-y-auto custom-scrollbar p-5">
              <div className="mb-4 pb-2 border-b border-zinc-200 dark:border-white/5 flex items-center justify-between sticky top-0 bg-zinc-50 dark:bg-[#080808] z-10 transition-colors duration-300">
              ...
              <div className="mt-8 mb-4 pb-2 border-b border-zinc-200 dark:border-white/5 flex items-center justify-between sticky top-0 bg-zinc-50 dark:bg-[#080808] z-10 transition-colors duration-300">
        ...
        <div className="mt-6">
          <button className="w-full py-3.5 rounded-xl border border-zinc-200 dark:border-white/5 bg-zinc-100 dark:bg-white/5 text-[9px] font-mono text-zinc-600 dark:text-zinc-500 uppercase tracking-widest hover:text-zinc-900 dark:hover:text-white hover:bg-zinc-200 dark:hover:bg-white/10 hover:border-zinc-300 dark:hover:border-white/10 transition-all flex items-center justify-center gap-2 group/audit">
