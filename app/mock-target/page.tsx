        ...
        <div className="space-y-6">
          <div className="p-6 rounded-3xl bg-white/5 border border-white/5 relative">
            ...
            <div className="space-y-4">
              ...
              <button
                className="w-full py-4 bg-emerald-500 rounded-xl text-black font-bold hover:bg-emerald-400 transition-colors text-sm px-2 mx-auto block"
              >
                <span className="block whitespace-nowrap">{t.confirmTrade}</span>
              </button>
            </div>
          </div>
          <button
