...
export default function MockTargetPage() {
  ...
  const [price, setPrice] = useState(10420.5); // Large number for overflow
      ...
      <AnimatePresence>
        {showGlobalSpinner && (
          ...
          >
            ...
            <p className="text-emerald-500 font-mono tracking-widest uppercase">
              {t.loading}
            </p>
          </motion.div>
        )}
